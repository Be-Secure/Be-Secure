...
[gitter.im][1].
  ...
  [1]: https://gitter.im/Be-Secure/Be-Secure -->
...
[submission guidelines][3].
  ...
  [2]: https://github.com/Be-Secure/Be-Secure/issues
...
3. **Pull Request**: After building the theme, commit the compiled output, push
  your branch to GitHub and send a PR to `Be-Secure:master`. If we
...
<!-- 
  [4]: https://squidfunk.github.io/Be-Secure/customization/#environment-setup
  [5]: https://squidfunk.github.io/Be-Secure/customization/#build-process -->
